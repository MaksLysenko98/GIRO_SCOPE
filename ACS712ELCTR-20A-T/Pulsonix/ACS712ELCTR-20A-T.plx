...
//820/261166/2.49/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS712ELCTR-20A-T" (originalName "ACS712ELCTR-20A-T")
	...
	(compDef "ACS712ELCTR-20A-T" (originalName "ACS712ELCTR-20A-T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS712ELCTR-20A-T"))
		...
		(attr "Mouser Part Number" "250-712ELCTR20AT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/ACS712ELCTR-20A-T?qs=pUKx8fyJudBUdhIPMFjOBQ%3D%3D")
		(attr "Arrow Part Number" "ACS712ELCTR-20A-T")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/acs712elctr-20a-t/allegro-microsystems")
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/SFDatasheet-0/sf-000553.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ACS712ELCTR-20A-T.stp")
